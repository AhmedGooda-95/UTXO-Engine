...
A production-oriented UTXO-based blockchain engine implemented in Rust.

**Double-SHA256 • Secp256k1 • Proof of Work • Mempool • Atomic Reorganization**

---

## 🚀 Demo Output

The following output demonstrates the complete UTXO engine workflow:
...
⛏️  [3/8] Mining 10 Blocks to achieve Coinbase Maturity...
...
💸 [4/8] Alice Sending 1500000000 sat (15.00000000 BTC) to Bob...
...
🛡️  [5/8] Simulating DOUBLE-SPEND ATTACK...
   ...
   ✅ SUCCESS: Double spend was immediately REJECTED!
   🛑 Reason: Double spend detected by the validation engine.
...
🔄 [7/8] Bob forwards 500000000 sat (5.00000000 BTC) to Charlie...
...
⏪ [8/8] Testing CHAIN REORGANIZATION & ATOMIC ROLLBACK...
   ...
   🔄 Reverted Block Hash:
      00bb8e8a1cca8746175bc308ca66430943edbe9c341cadeae6d153f4d7dfa67d
   ...
   ✅ All UTXO states rolled back successfully via UtxoDiff.
...
🚀 Running UTXO Engine Performance Benchmark...
   ...
   ⚡ Inserted 10,000 UTXOs in 8.24ms
   📊 Performance: 1,213,946 operations/sec

======================================================================
   ✨ All UTXO Engine modules and security checks PASSED! ✨
======================================================================
```
...
- 🔐 Secp256k1 key generation and digital signatures
- 🔗 Double-SHA256 hashing
- 🧱 Block creation and Proof of Work
- 💰 UTXO-based transaction processing
- 🛡️ Double-spend prevention
- 📨 Mempool management
- 🌳 Merkle inclusion proofs
- 🔄 Chain reorganization
- ⏪ Atomic UTXO rollback using `UtxoDiff`
- ⚡ UTXO performance benchmarking
...
This project is an educational and engineering-focused implementation of a UTXO-based blockchain engine in Rust, designed to demonstrate core blockchain concepts, transaction validation, state management, and chain reorganization.
